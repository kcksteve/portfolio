        ...
        if (this.isPlaying) {
            ...
            if (this.progress >= this.startDelay) {
                ...
                if (this.currentTo.x !== null) {
                    ...
                    this.pixiObject.scale.x = this.currentFrom.x + deltaX * this.easing(this.progressAnimation);
                }

                if (this.currentTo.y !== null) {
                    const deltaY =  this.currentTo.y - this.currentFrom.y;
                    this.pixiObject.scale.y = this.currentFrom.y + deltaY * this.easing(this.progressAnimation);
                }
            }
